...
/**
 * 该类封装了微博的位置服务接口，详情请参考<a
 * href="http://open.weibo.com/wiki/%E4%BD%8D%E7%BD%AE%E6%9C%8D%E5%8A%A1"
 * >微博位置服务</a>
 * 
...
public class PlaceAPI extends WeiboAPI {
	 ...
	 * @param listener
	 */
	public void parselocationtoGeo(String coordinate, RequestListener listener) {
		String url = "https://api.weibo.com/2/location/geo/geo_to_address.json";
		WeiboParameters parameters = new WeiboParameters();
		parameters.add("coordinate", coordinate);
	 ...
	 * @param listener
	 */
	public void nearbyTimeline(String lat, String lon, int range, long starttime, long endtime, SORT3 sort, int count, int page, boolean base_app, boolean offset, RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
		params.add("lat", lat);
		params.add("long", lon);
	 ...
	 * @param listener
	 */
	public void nearbyUsers(String lat, String lon, int range, long starttime, long endtime, SORT3 sort, int count, int page, boolean offset, RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
		params.add("lat", lat);
		params.add("long", lon);
		params.add("range", range);
	 ...
	 * @param listener
	 */
	public void nearbyPhotos(String lat, String lon, int range, long starttime, long endtime, SORT3 sort, int count, int page, boolean offset, RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
		params.add("lat", lat);
		params.add("long", lon);
		params.add("range", range);
	 ...
	 * @param pic
	 *            需要上传的图片路径，仅支持JPEG、GIF、PNG格式，图片大小小于5M。例如：/sdcard/pic.jgp；注意：
	 *            pic不能为网络图片
	 * @param isPublic
	 *            是否同步到微博，默认为不同步。
	 * @param listener
